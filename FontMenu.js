...
class MenuDropdown {
  constructior(toolbar, label, id, items) {
  ...
  createElement() {
    let dropdown = document.createElement("div", {class: '"menu-popup group"'});
    let btn = document.createElement('button', {'aria-haspopup': true, 'aria-controls': this.id, class: "item menu-button", 'aria-label': this.default, tabindex: -1})
    let list = document.createElement('ul', {role: 'menu', 'aria-label': this.label, id: this.id})
  }
